...
<xsl:stylesheet version="1.0" 
    ...
    *****************************************************************-->    
    ...
    <xsl:template name="bodypage">
        <form name="DropEntry" action="Controller?page=transaction&amp;mode=CompleteDrop" method="post">
    ...
    <xsl:template name="javascript">
        ...
        function onLoad()
        { 
            setInputHandlers(document.DropEntry,myChangeCallBack);  
        }
